<? 
	...
	{
		$system->table = "hospital.departamentos";
...
?>
	<form action="#" class="form-horizontal" id="form_registrar">
		...
		<div class="form-group">
			<label for="" class="control-label col-md-4 col-sm-4">Nombre Departamento</label>
			<div class="col-md-4 col-sm-4">
				<input type="text" id="nombre" name="nombre" class="form-control text-center" required="" value="<?= $departamento ? $departamento->nombre : ''; ?>">
			</div>
