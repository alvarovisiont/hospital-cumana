...
?>
	...
	<div class="box box-warning color-palette-box">
	    <div class="box-header with-border">
	      	<h2 class="box-title"><i class="fa fa-users"></i>&nbsp;&nbsp;Medicos Registrados</h2>
	    		...
	    		<tbody class="text-center">
	    			<?
	    				...
	    				foreach ($system->sql() as $row) 
	    				{
	    					...
	    					switch ($row->turno) {
	    						case '1':
	    							$turno = "<span class='badge alert-success'>Mañana</span>";
	    						break;
	    						
	    						default:
	    							$turno = "<span class='badge alert-success'>Noche</span>";
	    						break;
	    					}
