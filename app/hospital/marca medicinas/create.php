<? 
	...
	{
		$system->table = "hospital.marca_medicinas";
		$marca = $system->find($_GET['modificar']);
	}
?>
	<form action="#" class="form-horizontal" id="form_registrar">

		<input type="hidden" name="action" value="<?= $marca ? 'modificar' : 'registrar'; ?>">
		<input type="hidden" name="id_modificar" value="<?= $marca ? $marca->id : ''; ?>">
		
		<div class="form-group">
			<label for="" class="control-label col-md-2 col-sm-2 col-md-offset-2 col-sm-offset-2">Marca</label>
			<div class="col-md-4 col-sm-4">
				<input type="text" id="nombre" name="nombre" class="form-control text-center" required="" value="<?= $marca ? $marca->nombre : ''; ?>">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-offset-1 col-sm-offset-1  col-md-3 col-sm-3">
				<a href="<?= './index.php' ?>">Regresar a la Vista de Marcas</a>
			</div>
		</div>
