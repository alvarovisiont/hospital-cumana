...
?>
	<div class="info-box">
	  <!-- Apply any bg-* class to to the icon to color it -->
	  	...
	  	<div class="info-box-content">
		    <span class="info-box-text">Total Marcas </span>
	...
	<div class="box box-danger color-palette-box">
	    <div class="box-header with-border">
	      	<h2 class="box-title"><i class="fa fa-heart"></i>&nbsp;&nbsp;Marcas Registradas</h2>
	      	<div class="pull-right">
	       		<a href="./create.php" class="btn btn-primary btn-flat btn-md pull-right">Registrar Marcas&nbsp;&nbsp;<i class="fa fa-pencil"></i><i class="fa fa-plus"></i></a>
	      	</div>
	    </div>
	    <div class="box-body">
