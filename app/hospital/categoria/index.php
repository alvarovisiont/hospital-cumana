...
?>
	...
	<div class="box box-danger color-palette-box">
	    <div class="box-header with-border">
	      	<h2 class="box-title"><i class="fa fa-bank"></i>&nbsp;&nbsp;Categorias Registradas</h2>
	      	<div class="pull-right">
	       		<a href="./create.php" class="btn btn-warning btn-flat btn-md pull-right">Registrar Categorias&nbsp;&nbsp;<i class="fa fa-pencil"></i><i class="fa fa-plus"></i></a>
	      	</div>
	    </div>
	    <div class="box-body">
