<? 
	...
	$total_departamentos = $system->count();
...
?>	
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="small-box bg-yellow">
        ...
        <a href="#" class="small-box-footer">
          Ver areas asociadas <i class="fa fa-arrow-circle-right"></i>
        </a>
      </div>
    </div>
  </div>
    ...
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-bank"></i>Departamentos Registrados</h3>
      <div class="pull-right">
        <a href="./registrar.php" class="btn btn-success btn-flat btn-md pull-right">Registrar Departamento&nbsp;&nbsp;<i class="fa fa-user-plus"></i></a>
      </div>
    </div>
    <div class="box-body">
			<table class="table table-bordered table-hover table-condensed">
				...
				<tbody class="text-center">
					<?
						$system->sql = "SELECT *, to_char(created_at, 'dd-Mon-YYYY,HH24:MM:SS') as created_at1 from public.departamentos";
						foreach ($system->sql() as $row) 
						{
							...
							echo "
									<tr>
										...
										<td><i class='fa fa-".$row->fa_icon."'></i></td>
	...
	$(function(){
		...
		$('.eliminar').click(function(e){
			...
			var id = $(this).data().eliminar,
					...
					agree = confirm('Esta seguro que desea eliminar este Departamento?')
			if(agree)
			{
				$.getJSON('./operaciones.php',{id: id, action: 'eliminar'}, function(data){
					...
					if(data.r)
					{
						...
						$('#aviso').children('#texto').empty().text('Departamento eliminado con éxito')
					...
					else
					{
						...
						$('#aviso').children('#texto').empty().text('No se puede eliminar el Departamento porque esta asociado con otros registros')
